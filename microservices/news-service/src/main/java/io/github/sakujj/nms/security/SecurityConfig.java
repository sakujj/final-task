...
public class SecurityConfig {
     ...
     * @param httpSecurity http security instance to configure and build SecurityFilterChain
    ...
    /**
     * A roles converter specific to Keycloak jwt tokens, i.e. when roles specified with claim of pattern
